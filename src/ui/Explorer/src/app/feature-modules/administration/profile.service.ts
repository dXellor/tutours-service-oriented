...
export class ProfileService {
  ...
  getPerson(userId: number): Observable<Profile> {
    return this.http.get<Profile>(
      `${environment.apiHost}profile/zelimdaumrem/${userId}`
    );
  }
  ...
  unfollow(followingId: number): Observable<PagedResults<Profile>> {
    return this.http.put<PagedResults<Profile>>(
      `${environment.apiHost}profile/unfollow`,
      followingId
    );
  }
  ...
  follow(followingId: number): Observable<PagedResults<Profile>> {
    return this.http.put<PagedResults<Profile>>(
      `${environment.apiHost}profile/follow`,
      followingId
    );
  }
  ...
  updateProfile(userId: number, updatedProfile: Profile): Observable<Profile> {
    return this.http.put<Profile>(
      `${environment.apiHost}profile/${userId}`,
      updatedProfile
    );
  }

  getProfiles(): Observable<PagedResults<Profile>> {
    return this.http.get<PagedResults<Profile>>(
      environment.apiHost + `profile/not-followed`
    );
  }
  ...
  getMessages(followerId: number): Observable<PagedResults<ChatMessage>> {
    return this.http.get<PagedResults<ChatMessage>>(
      `${environment.apiHost}chat/${followerId}`
    );
  }
